    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand logo h1 align-self-center" href="index.html">
                <span class="first-text">Oriental </span>
                <span class="second-text">Group</span>
            </a>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li>
                            ...
                            ORIENTAL GROUP N ° 200 Lot El Massar, Sidi Ghanem Industrial Estate. Route de Safi 40 100 Marrakech MOROCCO
                        </li>
                        <li>
                            <i class="fa fa-phone fa-fw"></i>
                            <a class="text-decoration-none" href="tel:010-020-0340">+212 524 335 449</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope fa-fw"></i>
                            <a class="text-decoration-none" href="mailto:info@company.com">contact@group-oriental.com</a>
                        </li>
                    </ul>
                </div>
